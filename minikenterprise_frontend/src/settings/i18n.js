...
const translations = {
    en: {
        ...
        pwmLimitHeading: "Speed Limiting",
        voltageBasedPwmLimitLabel: "Voltage-based",
        manualPwmLimitLabel: "Manual",
        pwmLimitExplanation: "Automatically caps speed based on the battery's rested voltage to prevent the motor driver from overheating (recommended). Switch to Manual to set fixed limits instead.",
        manualRegularPwmLimitPercentLabel: "Normal Speed Limit (%)",
        manualBoostPwmLimitPercentLabel: "Boost Speed Limit (%)",
    ...
    de: {
        ...
        pwmLimitHeading: "Geschwindigkeitsbegrenzung",
        voltageBasedPwmLimitLabel: "Spannungsbasiert",
        manualPwmLimitLabel: "Manuell",
        pwmLimitExplanation: "Begrenzt die Geschwindigkeit automatisch anhand der Ruhespannung der Batterie, um eine Überhitzung des Motortreibers zu verhindern (empfohlen). Auf Manuell umschalten, um feste Grenzwerte einzustellen.",
        manualRegularPwmLimitPercentLabel: "Normale Geschwindigkeitsbegrenzung (%)",
        manualBoostPwmLimitPercentLabel: "Boost-Geschwindigkeitsbegrenzung (%)",
